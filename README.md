...
The do-file and m-files run automatically from top to bottom, but the user may need to adjust the file paths for reading the data and saving the outputs. The m-files may require some nested functions (also within this repository) to do some part of the analysis. Additional nested m-functions to produce tables and for under-5 mortality modelling are available at: https://github.com/Romero-Prieto/1a0 (also within this GitHub account).   
# Model_B
